...
export const SlideButton: React.FunctionComponent<ISlideButtonProps> = ({
  type,
  text,
  slide_text,
  icon,
  ...
  return (
    ...
    >

     {
        ...
        justify-center w-full h-full text-white duration-300 
        -translate-x-full bg-blue-600 
        group-hover:translate-x-0 ease-in"
        >
        {icon} &nbsp;{slide_text}
        </span>
        <span
